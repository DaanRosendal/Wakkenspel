...
public class Dobbelsteen {
	...
	/**
	 * genereer een willekeurig getal tussen 1 en 6 en bepaal het aantal wakken
	...
	/**
	 * Haal het aantal pingu�ns op
	 * 
	 * @return het aantal pingu�ns
	 */
	...
	public void teken(Graphics g) {
		...
		g.fillRoundRect(x - borderWidth, y - borderWidth, size + (borderWidth * 2), size + (borderWidth * 2),
				borderRadius + (borderWidth * 2), borderRadius + (borderWidth * 2));
